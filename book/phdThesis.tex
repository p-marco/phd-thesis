...
Fig.\ref{fig:unnamed-chunk-1}.

\begin{figure}

{\centering \includegraphics[width=0.7\linewidth]{phdThesis_files/figure-latex/unnamed-chunk-1-1} 

}

\caption{Representation of syntactic structures}\label{fig:unnamed-chunk-1}
\end{figure}
