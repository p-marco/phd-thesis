...
In this sense, while a *corpus-based* approach aims to generalize a picture *before* than an actual recognition of the data and the datasets, it can be possible to 
